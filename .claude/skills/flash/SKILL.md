...
1. Copy changed files to the board:
   ...
   mpremote cp web/index.html web/wifi.html web/docs.html web/update.html web/speech.html web/music.html :web/
   ```
2. Soft reset:
   ```
...
- Filesystem web: `web/index.html`, `web/wifi.html`, `web/docs.html`, `web/update.html`, `web/speech.html`, `web/music.html`
